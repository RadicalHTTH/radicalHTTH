 ...
 *  Add annotations and minor revised by Hayate Takeuchi (Final Edit: March 31 2025)
 ***********************************************************/

#include <stddef.h>

#define ITMAX 400             // Maximum number of iterations
#define EPS 3.0e-8            // Convergence criterion for numerical precision
